...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/add-scrap" method="POST">
  ...
  <div class="container-sm mt-2 rounded pb-1" style="background-color: lightgrey;">
    <div class="container-fluid my-1 d-flex justify-content-around align-items-center">
      <h2>Piezas en scrap</h2>
      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Poner en Scrap</button>
    </div>
    <table class="table">
      <thead>
